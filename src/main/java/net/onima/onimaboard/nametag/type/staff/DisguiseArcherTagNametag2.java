...
public class DisguiseArcherTagNametag2 extends StaffNametag {

	public DisguiseArcherTagNametag2() {
		super(NametagType.DISGUISED_TAG_2, "§e[Disguise]§c ", null, false);
	}

	@Override
	public Nametag applicableNametag(Board board) {
		return board.getNametag(NametagType.ARCHER_TAG_2);
	}
