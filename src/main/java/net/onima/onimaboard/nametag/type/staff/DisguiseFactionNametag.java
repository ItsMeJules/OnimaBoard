...
public class DisguiseFactionNametag extends StaffNametag {

	public DisguiseFactionNametag() {
		super(NametagType.DISGUISED_FAC, "§e[Disguise]" + Relation.MEMBER.getColor().toString() + ' ', null, false);
	}
	
	@Override
	public Nametag applicableNametag(Board board) {
		return board.getNametag(NametagType.FACTION);
	}
