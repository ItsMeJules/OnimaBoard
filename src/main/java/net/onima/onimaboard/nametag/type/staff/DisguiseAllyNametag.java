...
public class DisguiseAllyNametag extends StaffNametag {

	public DisguiseAllyNametag() {
		super(NametagType.DISGUISED_ALL, "§e[Disguise]" + Relation.ALLY.getColor().toString() + ' ', null, false);
	}

	@Override
	public Nametag applicableNametag(Board board) {
		return board.getNametag(NametagType.ALLY);
	}
