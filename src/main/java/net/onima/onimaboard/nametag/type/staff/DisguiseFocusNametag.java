...
public class DisguiseFocusNametag extends StaffNametag {

	public DisguiseFocusNametag() {
		super(NametagType.DISGUISED_FOC, "§e[Disguise]§d ", null, false);
	}

	@Override
	public Nametag applicableNametag(Board board) {
		return board.getNametag(NametagType.FOCUS);
	}
